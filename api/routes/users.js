...
router.post("/auth", async (req, res) => {
  ...
  try {
    ...
    let token = jwt.encode(payload, config.JWT.SECRET); //payload ve key alır
...
// auth ve registerın altına tanımladık çünkü authentication yapmadan token almadan kontrol yapamayız 
